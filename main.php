    ...
    <div class="title_wrap container">
      ...
      <div class="form-discount animated hidded delay-15s">
        ...
        <div class="form-discount_wrap">
          <form action="#">
            <div class="form-discount_title">Получите скидку<span>15%</span></div>
            <div class="form-discount_inner">
            ...
            <div class="form-discount_button">
              <input class="webform-submit button-primary form-submit ajax-processed" type="submit" value="Получить" name="op">
            </div>
            <div class="form-discount_descr">Введите ваше имя и телефон. Специалисты Бухгалтерский успех свяжутся с вами в течение 30 минут.</div>
          </form>
        </div>
      </div>
